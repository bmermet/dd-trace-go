...
[![Godoc](http://img.shields.io/badge/godoc-reference-blue.svg?style=flat)](https://godoc.org/github.com/bmermet/dd-trace-go/ddtrace)

### Installing

```bash
go get github.com/bmermet/dd-trace-go/...
```
...
The API is documented on [godoc](https://godoc.org/github.com/bmermet/dd-trace-go/ddtrace) as well as Datadog's [official documentation](https://docs.datadoghq.com/tracing/setup/go/). If you are migrating
